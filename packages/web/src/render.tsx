...
import { generateCatalog } from "neopilot-models";
import type { Model, ModelMetadata, Provider } from "neopilot-models";
...
function HelpDialog() {
  return (
    <dialog id="modal">
      ...
      <div class="body">
        <p>
          <a href="/">NeoModel</a> is a comprehensive open-source database of
        ...
        <div class="code-block">
          <code>
            curl <a href="/api.json">https://neomodels.vercel.app/api.json</a>
          </code>
        </div>
        <div class="code-block">
          <code>
            curl <a href="/models.json">https://neomodels.vercel.app/models.json</a>
          </code>
        </div>
        <div class="code-block">
          <code>
            curl <a href="/catalog.json">https://neomodels.vercel.app/catalog.json</a>
          </code>
        </div>
        <h2>Logos</h2>
        <p>
        ...
        <div class="code-block">
          <code>
            ...
            <a href="/logos/anthropic.svg">
              https://neomodels.vercel.app/logos/anthropic.svg
            </a>
          </code>
        </div>
        <h2>Contribute</h2>
