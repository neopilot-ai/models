<p align="center">
  <a href="https://neomodels.vercel.app">
    <picture>
      <source srcset="./logo-dark.svg" media="(prefers-color-scheme: dark)">
      <source srcset="./logo-light.svg" media="(prefers-color-scheme: light)">
      <img src="./logo-light.svg" alt="Neopilot Models logo">
    </picture>
  </a>
</p>
...
[Neopilot Models](https://neomodels.vercel.app) is a comprehensive open-source database of AI model specifications, pricing, and capabilities.

There's no single database with information about all the available AI models. We started Neopilot Models as a community-contributed project to address this. We also use it internally in [neocode](https://neocode.ai).
...
```bash
curl https://neomodels.vercel.app/api.json
```
...
```bash
curl https://neomodels.vercel.app/logos/{provider}.svg
```
...
Neopilot Models is an open-source project. Feel free to contribute!
